  ...
  return (
    <>
      <a href={url} target="_blank">
        <div className="h-64 w-64 overflow-hidden rounded-xl bg-neutral-800 p-2 text-white shadow-md transition-colors duration-300 hover:bg-neutral-700 md:w-72 xl:w-96">
