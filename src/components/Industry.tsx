...
export default function Indusrty({
  ...
  return (
    <div className="transition-color h-64 w-64 overflow-hidden rounded-lg text-white shadow-lg duration-300 md:h-64 md:w-64 xl:h-[20rem] xl:w-[25rem]">
      <div className="relative flex h-full flex-col items-center justify-center bg-neutral-800 transition-transform duration-300 hover:scale-110 hover:bg-neutral-700">
        <a href="/#form">
          <div>
            <Image
              src={img}
